 ...
 */
export default function SpeciesSidebarItem({id, species, size, keybindClick_func, zoomClick_func}) {
      ...
      return (
        <CardActions>
          <Stack spacing={1}>
            ...
            <Button sx={{flex:'1'}} style={{marginTop:'0px', fontSize:"x-small"}} size="small" onClick={(event)=>keybindClick_func(event)}>
