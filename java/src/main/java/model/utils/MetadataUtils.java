...
public class MetadataUtils
{
	 ...
	 */
	public static TiffOutputSet readOutputSet(File file) throws ImageWriteException, IOException, ImageReadException
	{
	 ...
	 * @throws ImageReadException If something went wrong reading the file...
	 */
	public static void writeOutputSet(TiffOutputSet outputSet, File file) throws IOException, ImageWriteException, ImageReadException
	{
		...
		FileUtils.copyFile(file, tempToWriteTo);
		...
		if (tempToWriteTo.exists())
		{
			...
			if (success == true) 
			{
				...
				FileUtils.moveFile(tempToWriteTo, file);
			}
		}
	}
